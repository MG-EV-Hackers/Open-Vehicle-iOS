  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    if ([received  isEqualToString: @"charge"]) {
      NSDictionary *data = @{@"soc":[NSNumber numberWithInt:self.car_soc],
                             ...
                             @"car_batt_power":[NSNumber numberWithDouble:self.car_batt_power],
                             ...
                             @"car_tambient":[NSNumber numberWithInt:self.car_ambient_temp],
                             @"car_trip":[NSNumber numberWithInt:self.car_trip],
                             @"car_energy_used":[NSNumber numberWithDouble:self.car_energy_used],
                             @"car_energy_recovered":[NSNumber numberWithDouble:self.car_energy_recovered],
